/*
 * Multiplication on Different Data Types, Learning How Java Prompts Data into int and Double automatically OR How to convert one type of data into another type automatically. */
...
class Multiplication
{
	public static void main(String[] args)
	{
		...
		int result3 = var5 * var6; // O/P is 65536
		System.out.println("char*char=int: " + result3);

		// int * int
		int var7 = 50; // if here store 2147483647
		int var8 = 2; // if here store 2147483647
		int result4 = var7 * var8; // O/P is exceeds the range 
		System.out.println("int*int=int: " + result4);

		// long * long
		long var9 = 1000l; // if here store 9223372036854775807l
		long var10 = 250l; // if here store 9223372036854775806l

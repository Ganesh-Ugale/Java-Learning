...
class Addition
{
	public static void main(String[] args)
	{
		...
		System.out.println("byte+byte=int: " + result1);  // 200

		// short + short
		short var3 = 200;
		short var4 = 500;
		int result2 = var3 + var4;
		System.out.println("short+short=int: " + result2); // 700

		// char + char
		char var5 = 'A'; //65
		char var6 = 'B'; //66
		int result3 = var5 + var6;
		System.out.println("char+char=int: " + result3); // 131
		...
		System.out.println("int+int=int: " + result4); // -2147482649

		// long + long
		long var9 = 123456789l; // if here store 9223372036854775807l
		long var10 = 123456789l; // if here store 9223372036854775807l
		long result5 = var9 + var10; // according to above condition O/P is -2 bcz exceeds the range of long
		System.out.println("long+long=long: " + result5); // 246913578

		// float + float
		float var11 = 506010.26f;
		float var12 = 8945623.25f;
		float result6 = var11 + var12;
		System.out.println("float+float=float: " + result6); // 9451633.0

		// double + double
		double var13 = 1.1;
		double var14 = 1.26;
		double result7 = var13 + var14;
		System.out.println("double+double=double: " + result7); // 2.3600000000000003

		// String + String
		String var15 = "Hello";
		String var16 = "Java";
		String result8 = var15 + var16; // String Concatination is Done Here
		System.out.println("String+String=String: " + result8); // HelloJava
